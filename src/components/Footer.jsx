      ...
      <Container>
        ...
        <Row className="text-center mb-4">
          <Col lg={8} className="mx-auto">
            <p>
              InterviewG envisions a world where hiring is seamless and
              insightful. Our mission is to empower interviewers with innovative
              tools, fostering better connections and unlocking the potential of
              talent.
            </p>
          </Col>
        </Row>
