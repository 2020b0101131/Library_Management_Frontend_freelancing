        ...
        <div className="col-lg-10">
          <div className="text-center mb-5">
            ...
            <p className="lead text-muted">
              Add, review, and practice important questions for java interviews.
            </p>
          </div>
          ...
          <div className="card shadow-sm">
            <div className="card-body">
              ...
              <ul className="list-group list-group-flush">
                ...
                {[
                  "What are the main features of Java that make it a popular programming language?",
                  "Explain the difference between `==` and `equals()` in Java.",
                  "What is the concept of inheritance in Java? How does it work?",
                  "What are the different types of access modifiers in Java and their usage?",
                  ...
                  "How do you handle exceptions in Java? Explain the difference between checked and unchecked exceptions.",
                  "What is multi-threading in Java and how do you create a thread?",
                ].map((question, index) => (
                  <li
                    key={index}
                    className="list-group-item d-flex justify-content-between align-items-center"
